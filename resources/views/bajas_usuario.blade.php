...
<!--Buscar el RFC-->
          ...
          <form action="{{'/usuario/inicio/bajas'}}" method="post">
          <h6>Baja por correo </h6>

          <input type="hidden" name="_token" value="{{ csrf_token() }}">
             <input type="email" name="email" placeholder="Inserte su correo"  value=""><br>
            {!! $errors->first('email','<small class="msj" >:message</small>') !!} <br>
